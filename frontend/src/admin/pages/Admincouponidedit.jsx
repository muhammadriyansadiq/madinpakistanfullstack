...
<form action="">
                    <div className='p-5 w-full'>
                        <div className=''>
                            ...
                            <input value={"get from db"}   id="title" type='search' className=' mt-2  leading-10 border-[1px] border-gray-500 rounded-md px-1   w-full' placeholder=' Enter Coupon Code' />
                        </div>
                    </div>
                    ...
                    <div className='px-5 pb-5 w-full '>
                        <div>
                            ...
                            <option value="volvo">get from db</option>
                            <option value="saab">get from d</option>
                    ...
                    <div className='pb-5 px-5 w-full'>
                        <div className=''>
                            ...
                            <input value={"get from db"}   id="title" required type='search' className=' mt-2  leading-10 border-[1px] border-gray-500 rounded-md px-1   w-full' placeholder=' Enter Coupon Value' />
                        </div>
                    </div>
                    ...
                    <div className='px-5 pb-5 w-full '>
                        <div>
                            ...
                            <option value={"get from db"}>get from db</option>
                            <option value={"get from db"}>get from db</option>
...
export default Admincouponidedit;
