        ...
        <div className='w-full flex justify-center mt-9 allorders'>
                <div className='w-full border-[2px] rounded-md mb-3'>
                    <div className='flex justify-between p-5 border-b-[1px]'>
                        <div className='font-sans font-medium text-gray-700 text-[18px]'>Order Lists</div>
                                        ...
                                        {currentItems.map((row, index) => (
                                            <tr key={index} className="border border-gray-300">
                                                ...
                                                <td className=" py-2 border border-gray-300 text-center">
                                                    ...
                                                    <Link to={'/admin/order/id'} className= "  bg-white rounded-lg border-[1px] border-yellow-500 text-[19px] p-2 text-yellow-500 hover:bg-yellow-500 hover:text-white"><MdRemoveRedEye /></Link>
                                                    <Link to={'/admin/order/id/edit'} className= " mx-2  bg-white rounded-lg border-[1px] border-green-700 text-[19px] p-2 text-green-700 hover:bg-green-700 hover:text-white"><FaRegEdit /></Link>
