...
<div className="containercard border-[2px] w-full lg:w-[23%] relative cursor-pointer">
  ...
  <img className=" w-full" src="https://media.istockphoto.com/id/1293366109/photo/this-one-match-perfect-with-me.jpg?s=1024x1024&w=is&k=20&c=ljpyNgsm90gjZHYRuHWfLXU-PTZk7IERjJW5v3NZ70U=" alt="" />
...
<div className="containercard border-[2px] w-full lg:w-[23%] relative cursor-pointer my-4 lg:my-0"> 
  <div className="newbadge absolute right-3 bg-green-600 px-1 text-white rounded-lg top-3">new</div>
  <img className=" w-full" src="https://media.istockphoto.com/id/1293365002/photo/this-one-match-perfect-with-me.jpg?s=612x612&w=0&k=20&c=V0jtW0eBsgB1kliSdLzp44TrT0p43T2jedZNf-VsRYo=" alt="" />
  <div className="cardanima pl-2">
    <div><button>Add to Cart</button></div>
...
<div className="containercard border-[2px] mb-4 lg:mb-0  lg:w-[23%] relative cursor-pointer">
  <div className="newbadge absolute right-3 bg-green-600 px-1 text-white rounded-lg top-3">new</div>
  <img className=" w-full" src="https://media.istockphoto.com/id/1293366055/photo/this-one-match-perfect-with-me.jpg?s=612x612&w=0&k=20&c=LXBz4lDA-hURFE4tlsUq39F4tw8hvF7H6azHQGiT0p4=" alt="" />
  <div className="cardanima pl-2">
    <div><button>Add to Cart</button></div>
    <div className=" flex">< FaShoppingBag onClick={showLoading} className=" mr-2 hover:text-green-600"/>< TbJewishStar className="  hover:text-green-600"/></div>
  </div>
...
<div className="containercard border-[2px] w-full lg:w-[23%] relative cursor-pointer">
  <div className="newbadge absolute right-3 bg-green-600 px-1 text-white rounded-lg top-3">new</div>
  <img className=" w-full" src="https://media.istockphoto.com/id/1293366091/photo/this-one-match-perfect-with-me.jpg?s=612x612&w=0&k=20&c=f2h9V-hWw3kXAj3QTeYki77EYQdvlc_q5l_zQnQFnpQ=" alt="" />
  <div className="cardanima pl-2">
    <div><button>Add to Cart</button></div>
    <div className=" flex">< FaShoppingBag onClick={showLoading} className=" mr-2 hover:text-green-600"/>< TbJewishStar className="  hover:text-green-600"/></div>
  </div>
