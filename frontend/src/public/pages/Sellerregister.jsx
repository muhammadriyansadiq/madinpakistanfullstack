        ...
        <div className='text-center flex justify-center items-center flex-col my-3'>
          ...
          <div className='mt-6 w-11/12 lg:w-3/12'>
            ...
            >
              ...
              >
                <input type='number' className='w-full py-3 rounded-md pl-2 border-[1px] hover:border-green-600'/>
              </Form.Item>
              {/* Password Field */}
              <Form.Item
                label="Password"
              ...
              <Form.Item>
                ...
                <Link to={'/seller/login'} className=' hover:text-green-400'>  Login </Link>
                </button>
              </Form.Item>
            </Form>
          </div>
