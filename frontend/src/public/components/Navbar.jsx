...
import { sethamberg,setviewcart, sethambergexpander, setwindowwidth, setwishlistopen } from "../../redux/Counterslice";
...
useEffect(() => {
  ...
  console.log("windowwidth",windowWidths,"hamberg",hamberg, "hambergexpander",hambergexpander)
          ...
          <div className="w-11/12  flex flex-col justify-between lg:flex-row py-1 ">
            ...
            <div className="mt-4 w-[100%] sm:w-[85%] flex justify-between lg:w-[35%] lg:mt-0">
              <div className="flex items-center cursor-pointer hover:text-green-700 text-[17px]">
                ...
                <Link to={'/trackrecord'} className="pl-2 text-[10px] lg:text-[14px]">Track Order</Link>
              </div>
              ...
              <div className="flex items-center cursor-pointer hover:text-green-700 text-[17px]">
                ...
                <Link to={'/seller/register'} className=" text-[10px] lg:text-[14px]">Become a Seller</Link>
              </div>
...
<ViewCart />
  ...
  <div>
    ...
    <GiHamburgerMenu onClick={hambergwexpanderfunction}  className=""/>
  </div>
</div>:
""
}
...
<div className=" pl-3 shadow-lg py-2 fixed top-0 bg-white w-full z-50">
    ...
    <div onClick={hambergwexpanderfunction} className=" font-extrabold text-green-600">X</div>
