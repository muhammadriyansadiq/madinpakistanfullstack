...
const Adminproduct = () => {
  ...
  const data = [
    // Add your data here
    { col1: '1', col2: 'cluster prism', col3: 'Super bike', col4: 'Yes', col5: '320/=',col6:"-",col7:"hot",col8:"25",col9:"https://cdn.pixabay.com/photo/2024/05/02/16/22/parrots-8735074_640.jpg",col10:"active"},
    { col1: '1', col2: 'cluster prism', col3: 'Super bike', col4: 'Yes', col5: '320/=',col6:"-",col7:"hot",col8:"25",col9:"https://cdn.pixabay.com/photo/2024/05/02/16/22/parrots-8735074_640.jpg",col10:"active" },
    { col1: '1', col2: 'cluster prism', col3: 'Super bike', col4: 'Yes', col5: '320/=',col6:"-",col7:"hot",col8:"25",col9:"https://cdn.pixabay.com/photo/2024/05/02/16/22/parrots-8735074_640.jpg",col10:"active" },
    { col1: '1', col2: 'cluster prism', col3: 'Super bike', col4: 'Yes', col5: '320/=',col6:"-",col7:"hot",col8:"25",col9:"https://cdn.pixabay.com/photo/2024/05/02/16/22/parrots-8735074_640.jpg",col10:"active" },
    { col1: '1', col2: 'cluster prism', col3: 'Super bike', col4: 'Yes', col5: '320/=',col6:"-",col7:"hot",col8:"25",col9:"https://cdn.pixabay.com/photo/2024/05/02/16/22/parrots-8735074_640.jpg",col10:"active" },
        ...
        <div className='w-full flex justify-center mt-9 allorders'>
                <div className='w-full border-[2px] rounded-md mb-3'>
                    <div className='flex justify-between p-5 border-b-[1px]'>
                        <div className='font-sans font-medium text-gray-700 text-[18px]'>Product List</div>
                        <Link to={'/admin/product/create'}>
                            <div className='cursor-pointer'>
                                <button className='bg-green-700 border-[1px] text-white p-2 rounded-md hover:bg-white hover:text-green-700 hover:border-green-700'>
                                   <span className=" text-[17px] font-semibold">AddProduct</span> 
                                </button>
                            </div>
                        </Link>
                    </div>
                                ...
                                <table className="w-full border-[2px] bg-white  border-gray-300">
                                    <thead>
                                        <tr className="bg-green-700 text-white leading-10 border-gray-500 border-[2px]">
                                            ...
                                            <th className="px-4 py-2 border-[1px] border-gray-400">Discount</th>
                                            <th className="px-4 py-2 border-[1px] border-gray-400">Condition</th>
                                            <th className="px-4 py-2 border-[1px] border-gray-400">Stock</th>
