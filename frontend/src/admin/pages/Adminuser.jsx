...
const Adminuser = () => {
  ...
  const data = [
    // Add your data here
    { col1: '1', col2: 'Bike', col8: 'Super bike', col4: 'No', col5: 'Automobie',col6:"opop",col7:"ok" ,col3:"https://cdn.pixabay.com/photo/2024/05/02/16/22/parrots-8735074_640.jpg",col9:"muhammariyansadiq@gmail.com"},
    { col1: '1', col2: 'Bike', col8: 'Super bike', col4: 'No', col5: 'Automobie',col6:"opop",col7:"ok",col3:"https://cdn.pixabay.com/photo/2024/05/02/16/22/parrots-8735074_640.jpg",col9:"muhammariyansadiq@gmail.com" },
    { col1: '1', col2: 'Bike', col8: 'Super bike', col4: 'No', col5: 'Automobie',col6:"opop",col7:"ok",col3:"https://cdn.pixabay.com/photo/2024/05/02/16/22/parrots-8735074_640.jpg",col9:"muhammariyansadiq@gmail.com" },
    { col1: '1', col2: 'Bike', col8: 'Super bike', col4: 'No', col5: 'Automobie',col6:"opop",col7:"ok",col3:"https://cdn.pixabay.com/photo/2024/05/02/16/22/parrots-8735074_640.jpg",col9:"muhammariyansadiq@gmail.com" },
    { col1: '1', col2: 'Bike', col8: 'Super bike', col4: 'No', col5: 'Automobie',col6:"opop",col7:"ok",col3:"https://cdn.pixabay.com/photo/2024/05/02/16/22/parrots-8735074_640.jpg" ,col9:"muhammariyansadiq@gmail.com"},
        ...
        <div className='w-full flex justify-center mt-9 allorders'>
                <div className='w-full border-[2px] rounded-md mb-3'>
                    <div className='flex justify-between p-5 border-b-[1px]'>
                        <div className='font-sans font-medium text-gray-700 text-[18px]'>User List</div>
                        <Link to={'/admin/user/create'}>
                            <div className='cursor-pointer'>
                                <button className='bg-green-700 border-[1px] text-white p-2 rounded-md hover:bg-white hover:text-green-700 hover:border-green-700'>
                                   <span className=" text-[17px] font-semibold">Add User</span> 
                                </button>
                            </div>
                        </Link>
                    </div>
                                ...
                                <table className="w-full border-[2px] bg-white  border-gray-300">
                                    <thead>
                                        <tr className="bg-green-700 text-white leading-10 border-gray-500 border-[2px]">
                                            ...
                                            <th className="px-4 py-2 border-[1px] border-gray-400">JoinDate</th>
                                            <th className="px-4 py-2 border-[1px] border-gray-400">Role</th>
                                    ...
                                    <tbody>
                                        {currentItems.map((row, index) => (
                                            <tr key={index} className="border border-gray-300">
                                                ...
                                                <td className="px-4 py-2 border border-gray-300 text-center">{row.col9}</td>
                                                <td className="px-4 py-2 border border-gray-300 text-center">
                                                    <div >
                                                        <img src={row.col3} alt="logo" className=" object-cover h-[50px] w-full" />
                                                    </div>
                                                </td>
                                                ...
                                                <td className=" py-2 border border-gray-300 text-center">
                                                    ...
                                                    <Link to={'/admin/user/id/edit'} className="bg-white rounded-lg border-[1px] border-green-700 text-[19px] p-2 text-green-700 hover:bg-green-700 hover:text-white"><FaRegEdit /></Link>
