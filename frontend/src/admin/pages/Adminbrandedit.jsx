...
<form action="">
                    <div className='p-5 w-full'>
                        <div className=''>
                            ...
                            <input value={"get fron db"}   id="title" type='search' className=' mt-2  leading-10 border-[1px] border-gray-500 rounded-md   w-full px-1' placeholder=' Enter Name' />
                        </div>
                    </div>
                    ...
                    <div className='px-5 pb-5 w-full '>
                        <div>
                            ...
                            <select value={"get fron db"} name="cars" id="select"  className=' mt-2  py-3 leading-10 border-[1px] border-gray-500 rounded-md   w-full px-1'>
                    ...
                    <div className='p-5  w-full '>
                        <div className=''>
                            <button className=' bg-white py-2 border-[2px] font-semibold border-green-700 hover:bg-green-700 hover:text-white px-5 text-green-700 rounded-md '>Reset</button>
